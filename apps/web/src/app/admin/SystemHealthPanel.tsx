      ...
      <div className="border-t border-border/80 pt-10">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="border border-border/80 bg-card/70 p-6">
            ...
            <p className="mt-1 text-xs text-muted-foreground">FTS5 rows vs catalog rows</p>
          ...
          <div className="border border-border/80 bg-card/70 p-6">
            ...
            <div className="mt-6 text-sm text-muted-foreground leading-relaxed">
              Purges expired sessions, verification tokens, old sync records, and expired registered
              bundles. Runs a vacuum afterward.
            </div>
      ...
      <div id="user-overview" className="border-t border-border/80 pt-10 scroll-mt-40">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="border border-border/80 bg-card/70 p-6">
            ...
            <p className="mt-1 text-xs text-muted-foreground">User-curated bundles</p>
          </div>
