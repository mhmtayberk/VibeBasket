...
export function DocsTabGettingStarted() {
	return (
		<div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
			...
			<div className="mb-24">
				<h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-foreground mb-8 leading-tight">Getting Started</h1>
				<p className="text-base sm:text-lg text-[#bdc9c2] max-w-3xl leading-relaxed">Welcome to the VibeBasket ecosystem. This guide provides a rapid introduction to initializing your workspace, understanding the core architecture, and applying your first AI-engineered setup bundle.</p>
			</div>
              ...
              <div>
				...
				<section id="installation" className="scroll-mt-28">
					...
					<div className="prose prose-invert max-w-none text-sm text-[#bdc9c2] leading-relaxed space-y-8">
						<p className="max-w-3xl">To inject this compiled developer context into your target codebase, copy the generated command and execute it inside your local project workspace:</p>
						<div className="border border-[#3e4944] rounded-[2px] overflow-hidden bg-[#101412] shadow-xl group relative my-10">
							<div className="flex items-center justify-between px-6 py-4 border-b border-[#3e4944] bg-[#1c211e] select-none">
								<div className="flex items-center gap-2">
									...
									<span className="font-mono text-[10px] uppercase tracking-wider text-[#bdc9c2]">terminal</span>
								</div>
								<span className="font-mono text-[9px] uppercase text-[#bdc9c2]/50 select-none">bash</span>
							</div>
