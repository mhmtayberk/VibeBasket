        ...
        <section id="delimiters" className="scroll-mt-28">
          ...
          <div className="prose prose-invert max-w-none text-sm text-[#bdc9c2] leading-relaxed space-y-8">
            <p className="max-w-3xl">
              When writing rulesets, instructions, or custom skill profiles into codebases (for
              files like{" "}
              ...
              ), the CLI prevents code pollution by wrapping updates inside strict delimiters:
            </p>
            ...
            <p className="max-w-3xl">
              This block model allows developers to easily apply updates. If the block boundary
              exists, VibeBasket executes a dynamic replacement. If missing, it appends it, leaving
              everything outside the delimiters untouched.
            </p>
          </div>
        </section>
      </div>
