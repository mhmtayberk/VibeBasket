      ...
      <div className="space-y-5 p-4">
        <div className="space-y-3">
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className={cn("space-y-0", items.length > 6 && showAllItems ? "max-h-80 overflow-y-auto pr-1" : "")}>
          ...
          {items.length > 6 ? (
            ...
            >
              {showAllItems ? <ChevronsUp className="h-3.5 w-3.5" /> : <ChevronsDown className="h-3.5 w-3.5" />}
        ...
        <div className="space-y-3 border-t border-border/70 pt-5">
          ...
          >
            ...
            {isBuilding ? "Generating" : bundleCommand ? "Copy Fresh Command" : "Generate Install Command"}
          </button>
        </div>
      </div>
    </aside>
